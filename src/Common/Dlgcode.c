...
#else
static unsigned char gpbSha512CodeSignCertFingerprint[64] = { // idrix_codeSign
...
static unsigned char gpbSha512MSCodeSignCertFingerprint[64] = { // idrix_Sha256CodeSign
